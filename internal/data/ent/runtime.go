...
import (
	...
	"moocss.com/gaea/internal/data/ent/schema"
...
func init() {
	...
	articleDescDeletedAt := articleFields[5].Descriptor()
	// article.DefaultDeletedAt holds the default value on creation for the deleted_at field.
	article.DefaultDeletedAt = articleDescDeletedAt.Default.(func() time.Time)
	...
	commentDescDeletedAt := commentFields[5].Descriptor()
	// comment.DefaultDeletedAt holds the default value on creation for the deleted_at field.
	comment.DefaultDeletedAt = commentDescDeletedAt.Default.(func() time.Time)
	...
	// tagDescDeletedAt is the schema descriptor for deleted_at field.
	tagDescDeletedAt := tagFields[5].Descriptor()
	// tag.DefaultDeletedAt holds the default value on creation for the deleted_at field.
	tag.DefaultDeletedAt = tagDescDeletedAt.Default.(func() time.Time)
}
