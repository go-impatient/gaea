...
func (cq *CommentQuery) QueryArticles() *ArticleQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, comment.ArticlesTable, comment.ArticlesColumn),
		)
...
func (cq *CommentQuery) WithArticles(opts ...func(*ArticleQuery)) *CommentQuery {
	query := &ArticleQuery{config: cq.config}
