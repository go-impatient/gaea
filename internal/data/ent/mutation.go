...
func (m *CommentMutation) ArticlesIDs() (ids []int64) {
...
func (m *CommentMutation) ResetArticles() {
	m.articles = nil
...
func (m *CommentMutation) AddedEdges() []string {
	...
	if m.articles != nil {
		edges = append(edges, comment.EdgeArticles)
	}
	return edges
}
