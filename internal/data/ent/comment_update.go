...
import (
	...
	"moocss.com/gaea/internal/data/ent/comment"
...
func (cu *CommentUpdate) SetArticlesID(id int64) *CommentUpdate {
	cu.mutation.SetArticlesID(id)
	return cu
}

// SetNillableArticlesID sets the "articles" edge to the Article entity by ID if the given value is not nil.
func (cu *CommentUpdate) SetNillableArticlesID(id *int64) *CommentUpdate {
	if id != nil {
		cu = cu.SetArticlesID(*id)
	}
	return cu
}

// SetArticles sets the "articles" edge to the Article entity.
func (cu *CommentUpdate) SetArticles(a *Article) *CommentUpdate {
	return cu.SetArticlesID(a.ID)
}
...
func (cu *CommentUpdate) ClearArticles() *CommentUpdate {
...
func (cu *CommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.ArticlesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   comment.ArticlesTable,
			Columns: []string{comment.ArticlesColumn},
			Bidi:    false,
...
// SetArticlesID sets the "articles" edge to the Article entity by ID.
func (cuo *CommentUpdateOne) SetArticlesID(id int64) *CommentUpdateOne {
	cuo.mutation.SetArticlesID(id)
	return cuo
}

// SetNillableArticlesID sets the "articles" edge to the Article entity by ID if the given value is not nil.
func (cuo *CommentUpdateOne) SetNillableArticlesID(id *int64) *CommentUpdateOne {
	if id != nil {
		cuo = cuo.SetArticlesID(*id)
	}
	return cuo
}

// SetArticles sets the "articles" edge to the Article entity.
func (cuo *CommentUpdateOne) SetArticles(a *Article) *CommentUpdateOne {
	return cuo.SetArticlesID(a.ID)
}
...
// ClearArticles clears the "articles" edge to the Article entity.
func (cuo *CommentUpdateOne) ClearArticles() *CommentUpdateOne {
