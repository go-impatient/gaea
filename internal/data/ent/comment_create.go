...
func (cc *CommentCreate) SetArticlesID(id int64) *CommentCreate {
	cc.mutation.SetArticlesID(id)
	return cc
}

// SetNillableArticlesID sets the "articles" edge to the Article entity by ID if the given value is not nil.
func (cc *CommentCreate) SetNillableArticlesID(id *int64) *CommentCreate {
	if id != nil {
		cc = cc.SetArticlesID(*id)
	}
	return cc
}

// SetArticles sets the "articles" edge to the Article entity.
func (cc *CommentCreate) SetArticles(a *Article) *CommentCreate {
	return cc.SetArticlesID(a.ID)
}
